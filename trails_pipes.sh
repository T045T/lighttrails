...
do
    ...
    REMOVE=$((${FRAME}-${TRAIL}))
    convert -brightness-contrast -${FINAL_DARKENING}% black-${REMOVE}.png miff:- | convert -negate - tmp.png
    mogrify -negate rolling-window.png
    composite -compose Divide rolling-window.png tmp.png miff: - | convert -negate - miff:- | convert -negate rolling-window.png
    mogrify -negate rolling-window.png
